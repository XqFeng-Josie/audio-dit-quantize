...
% ---- paper-local macros ----
\newcommand{\cfg}[1]{\texttt{#1}}          % config names: \cfg{late-ffn}
\newcommand{\zh}{\textsc{zh}}
\newcommand{\hard}{\textsc{hard}}
\newcommand{\en}{\textsc{en}}
\newcommand{\sig}{$^{\ast}$}               % paired bootstrap 95% CI excludes 0
\newcommand{\dworse}{$^{\dagger}$}         % significantly worse
...
\title{TTS-Q: Perception-Guided Post-Training Quantization of Text-to-Speech Diffusion Transformers}
\author{
    %Authors
...
\title{Toward On-Device Voice Cloning: 4-Bit Quantization of TTS Diffusion Transformers}
\author {
    % Authors
