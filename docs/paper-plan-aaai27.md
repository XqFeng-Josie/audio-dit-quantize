# AAAI-27 论文路线（2026-07-20 定稿版；证据全部指向 results-consolidated.md，旧 paper-outline.md 作废、仅其"弹药库/风险清单"两节继续引用）

## 0. 时间线（决定一切）

| 日期 | 事项 |
|---|---|
| **2026-07-21 (AoE)** | **abstract 截稿**（标题+摘要+作者，之后可改可撤——先占位） |
| **2026-07-28 (AoE)** | **全文截稿**（7 页正文 + 参考文献不计页） |
| 2026-07-31 (AoE) | 补充材料 + 代码 |
| 2027-02-16–23 | 会议（蒙特利尔） |

后备：若放弃本轮 → ICASSP 2027（预计 2026-09 截稿，需切分成 4 页单点故事）。本文档按 **AAAI-27 冲刺**编排。
...
| 日期 | 交付 |
|---|---|
| 7/21 | **注册 abstract**;AAAI LaTeX 骨架 + §3 设置节初稿;夜批(W16A4/W1/L2)开跑 |
